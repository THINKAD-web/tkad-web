...
const STATUS_STYLE: Record<Status, string> = {
  ...
  tentative: "border-border bg-muted text-foreground",
        ...
        <ul className="space-y-3">
          {items.map((it) => {
            ...
            return (
              <li
                key={it.id}
                className="flex flex-col gap-3 border-2 border-border bg-card p-5 sm:flex-row sm:items-start sm:gap-5"
              >
                <Link
                ...
                <div className="min-w-0 flex-1 space-y-2">
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    <div className="min-w-0">
                      <Link
                        href={`/media/${it.media.id}`}
                        className="line-clamp-1 text-base font-bold tracking-tight text-foreground hover:text-accent sm:text-lg"
                      >
                        {it.media.name}
                      </Link>
