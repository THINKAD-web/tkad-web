        ...
        <NeonSection tone="qp" className="pb-10 pt-16 sm:pt-20 lg:pt-24">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_320px]">
            <div className="rounded-[30px] border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 p-6 shadow-[0_36px_140px_rgba(0,0,0,0.72)] backdrop-blur tkad-neon-border sm:p-8">
              <span className="inline-flex rounded-full border dark:border-white/14 border-gray-200 dark:bg-white/10 bg-gray-100 px-3 py-1 tkad-type-label dark:text-white text-gray-900">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-3 tkad-type-label dark:text-white">
        ...
        <NeonSection tone="qp" className="pt-0">
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
            <article className="rounded-[30px] border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 p-6 shadow-[0_36px_140px_rgba(0,0,0,0.72)] backdrop-blur tkad-neon-border sm:p-8">
              ...
              <div className="mt-6 whitespace-pre-wrap break-words text-base leading-8 dark:text-white sm:text-base">
                {post.body}
              </div>
            ...
            <aside className="grid gap-4 self-start">
              <div className="rounded-[28px] border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 p-5 backdrop-blur tkad-neon-border">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  {post.author ? (
                    <Link
                      href={`/community/profile/${post.author.id}`}
                      className="inline-flex items-center gap-2 rounded-full border dark:border-white/14 border-gray-200 dark:bg-white/6 bg-gray-50 px-4 py-2 tkad-type-label dark:text-white text-gray-900 transition-colors hover:dark:bg-white/10 bg-gray-100"
                    >
              ...
              <div className="rounded-[28px] border dark:border-white/12 border-gray-200 bg-hermes/10 p-5 backdrop-blur tkad-neon-border">
                ...
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-2 rounded-full border dark:border-white/14 border-gray-200 dark:bg-black bg-white/20 px-4 py-2 tkad-type-label dark:text-white text-gray-700 transition-colors hover:dark:bg-white/10 bg-gray-100 hover:dark:text-white text-gray-900"
                >
