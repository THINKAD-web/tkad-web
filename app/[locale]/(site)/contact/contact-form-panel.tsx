...
export function ContactFormPanel() {
  ...
  const tabBase =
    "inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 tkad-type-title backdrop-blur transition-ui dark:border-white/10 dark:bg-white/5";
