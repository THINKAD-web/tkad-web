  ...
  return (
    <>
      ...
      <section className="bg-muted py-10">
        <div className="ui-container">
          <div className="mb-4 tkad-type-label text-muted-foreground">
              ...
              >
                <article className="flex h-full flex-col border-2 border-border bg-card">
                  <div className="relative h-40 overflow-hidden border-b-2 border-border bg-hero-void">
                    <div className="absolute inset-0 flex items-center justify-center tkad-type-label text-accent/70">
                      OOH CAMPAIGN
                    </div>
                    <div className="absolute inset-x-3 bottom-3 flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span className="border-2 border-hero-fg bg-transparent px-2 py-0.5 tkad-type-label text-hero-fg">
                        {item.year} · {item.location}
                      </span>
                    </div>
                    <div className="absolute right-3 top-3 inline-flex items-center gap-1 border-2 border-hero-fg bg-hero-void/80 px-2 py-1 tkad-type-label text-hero-fg">
          ...
          <div className="relative w-full max-w-3xl border-2 border-border bg-card">
            ...
            <div className="grid gap-0 overflow-hidden sm:grid-cols-5">
              <div className="relative h-56 border-b-2 border-border bg-hero-void sm:h-full sm:col-span-3 sm:border-b-0 sm:border-r-2">
                <div className="flex h-full flex-col justify-between p-5">
                  <div>
                    ...
                    <p className="mt-2 tkad-type-label text-accent">
                      {activeItem.client} · {activeItem.year}
                    </p>
                  </div>
                  <p className="mt-3 tkad-type-caption leading-relaxed tracking-tight text-hero-fg/75">
                    {`// `}{activeItem.location}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-between bg-card p-5 text-sm text-foreground sm:col-span-2">
                ...
                <div className="mt-4 border-2 border-accent bg-muted px-3 py-3 tkad-type-caption text-foreground">
                  {isKo ? (
                    <>
                      <p className="tkad-type-label text-accent">
                        [ INTERESTED? ]
