      ...
      <div className="tkad-landing-neon tkad-planner-neon tkad-auth-page min-h-[calc(100vh-72px)] px-4 py-10">
        <AuthCardShell>
          ...
          <BtnBlock
            ...
            className="mt-4 w-full rounded-[22px] border dark:border-white/14 border-gray-200 bg-[#03C75A] text-white shadow-[0_18px_60px_rgba(0,0,0,0.35)] transition-transform hover:-translate-y-0.5 hover:opacity-95"
          >
