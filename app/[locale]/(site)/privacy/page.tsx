...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isKo
    ? "개인정보 처리방침 | THINKAD 싱커드"
    : "Privacy Policy | THINKAD";
  const description = isKo
    ? "주식회사 싱커드(THINKAD) 개인정보 처리방침. 수집·이용·보관·파기 기준을 안내합니다."
    : "THINKAD privacy policy — how we collect, use, store, and delete personal data.";
