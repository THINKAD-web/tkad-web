      ...
      <div className="tkad-landing-neon tkad-planner-neon tkad-auth-page min-h-[calc(100vh-72px)] px-4 py-10">
        <AuthCardShell>
          ...
          <BtnBlock
            ...
            className="mt-4 w-full rounded-[22px] border border-white/14 bg-[#FEE500] text-[#191600] shadow-[0_18px_60px_rgba(0,0,0,0.35)] transition-transform hover:-translate-y-0.5 hover:opacity-95"
          >
