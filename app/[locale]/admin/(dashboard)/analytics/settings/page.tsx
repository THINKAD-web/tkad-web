    ...
    <div className="space-y-6 text-foreground">
      <div className="space-y-3">
        <Link
          ...
          className="inline-flex items-center gap-1.5 font-display text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground transition-colors hover:text-primary"
        >
