          ...
          <section className="space-y-4 border-2 border-border bg-card p-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <form method="get" className="flex flex-1 flex-col gap-2 sm:flex-row">
                ...
                <button
                  type="submit"
                  className="inline-flex h-11 items-center justify-center border-2 border-border bg-foreground px-4 tkad-type-label text-background transition-colors hover:bg-primary hover:border-primary hover:text-primary-foreground"
                >
                  검색 적용
                </button>
              </form>
              <Link
                ...
                className="inline-flex h-11 items-center justify-center border-2 border-border px-4 tkad-type-label text-foreground transition-colors hover:bg-muted/50"
              >
                필터 초기화
              </Link>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <Link
                    ...
                    className={[
                      "inline-flex items-center gap-2 border-2 px-3 py-2 tkad-type-label transition-colors",
          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-6">
              {selectedView === "trash" ? (
                <section className="space-y-2">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="tkad-type-caption tabular-nums text-muted-foreground">
                      {items.length}건
                    </span>
                  </div>
              ...
              {selectedView === "active" && newItems.length > 0 ? (
                <section className="space-y-2">
                  <div className="flex items-center justify-between gap-3">
                    <h2 className="tkad-type-label text-rose-700">
                      [ 미처리 우선 ]
                    </h2>
                    <span className="tkad-type-caption tabular-nums text-muted-foreground">
                      {newItems.length}건
              ...
              {selectedView === "active" && inProgressItems.length > 0 ? (
                <section className="space-y-2">
                  <div className="flex items-center justify-between gap-3">
                    <h2 className="tkad-type-label text-amber-700">
                      [ 진행중 ]
                    </h2>
                    <span className="tkad-type-caption tabular-nums text-muted-foreground">
              ...
              {selectedView === "active" && doneItems.length > 0 ? (
                ...
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-3">
                    <h2 className="tkad-type-label text-emerald-700">
                      [ 답변완료 ]
                    </h2>
                    <span className="tkad-type-caption tabular-nums text-muted-foreground">
                      {doneItems.length}건
