...
function campaignStatusClass(status: CrmCampaign["status"]) {
  if (status === "active") return "border-2 border-bx-black bg-bx-accent text-bx-white dark:border-bx-white";
  if (status === "ended") return "border-2 border-bx-black bg-bx-white text-bx-black dark:border-bx-white dark:bg-bx-black dark:text-bx-white";
  return "border-2 border-bx-black bg-bx-off text-bx-black dark:border-bx-white dark:bg-bx-gray-dim/30 dark:text-bx-white";
}

function segmentBadgeClass(segment: "high_value" | "potential" | "standard") {
  if (segment === "high_value") return "border-2 border-bx-black bg-bx-accent text-bx-white dark:border-bx-white";
  if (segment === "potential") return "border-2 border-bx-black bg-bx-white text-bx-black dark:border-bx-white dark:bg-bx-black dark:text-bx-white";
  return "border-2 border-bx-black bg-bx-off text-bx-black dark:border-bx-white dark:bg-bx-gray-dim/30 dark:text-bx-white";
}
...
export default function AdminCrmPage() {
  ...
  return (
    <div className="space-y-6 text-bx-black dark:text-bx-white">
            ...
            <CardContent className="flex flex-col gap-3 py-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="flex flex-wrap gap-3 text-sm">
                <div className="rounded-lg border bg-white px-3 py-2">
                  ...
                  <p className="text-lg font-bold text-bx-black dark:text-bx-white">
                  ...
                  return (
                    <div key={cp.id}>
                      ...
                      <div className="h-2 overflow-hidden rounded-full bg-slate-100">
                        <div
                          className="h-full rounded-full bg-bx-accent"
                          style={{ width: `${barPct}%` }}
                        />
                      </div>
                    </div>
                    ...
                    <>
                      <div className="grid grid-cols-2 gap-3 text-sm sm:grid-cols-4">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-bx-black dark:text-bx-white">{cp.ctr}%</p>
                        </div>
                        <div>
                          <p className="text-[10px] font-medium text-muted-foreground">
                            {t("vsGoal")}
              ...
              <tbody>
                {filteredLeads.map((l) => (
                  <tr key={l.id} className="border-b last:border-0">
                    <td className="py-3 pr-3 font-medium text-bx-black dark:text-bx-white">
      ...
      {tab === "intelligence" && (
        <div className="space-y-4">
          <Card className="border-2 border-dashed border-bx-black bg-bx-off dark:border-bx-white dark:bg-bx-gray-dim/30">
            <CardContent className="flex gap-3 py-4">
              <Sparkles className="h-5 w-5 shrink-0 text-bx-accent" />
              <p className="text-sm text-bx-black dark:text-bx-white">{t("modelNote")}</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <Target className="h-4 w-4 text-bx-accent" />
                {t("tabIntelligence")}
              </CardTitle>
                  ...
                  {intelligenceRows.map(
                    ({ customer: c, segment, repurchase, rationaleKeys }) => (
                      <tr key={c.id} className="border-b last:border-0">
                        <td className="py-3 pr-3 font-medium text-bx-black align-top dark:text-bx-white">
                          {companyLabel(c)}
                        </td>
        ...
        <div className="space-y-4">
          <div className="grid gap-4 lg:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base">
                  <Mail className="h-4 w-4 text-bx-accent" />
                  {t("autoReplyTitle")}
                </CardTitle>
              ...
              <CardContent className="relative space-y-3">
                ...
                <Button
                  type="button"
                  className="w-full border-2 border-bx-black bg-bx-black text-bx-white transition-colors hover:bg-bx-accent hover:border-bx-accent dark:border-bx-white dark:bg-bx-white dark:text-bx-black dark:hover:bg-bx-accent dark:hover:border-bx-accent dark:hover:text-bx-white"
                  disabled={
            ...
            <Card>
              ...
              <CardContent>
                <Button
                  ...
                  className={
                    autoSchedule
                      ? "border-2 border-bx-black bg-bx-accent text-bx-white transition-colors hover:bg-bx-black hover:border-bx-black dark:border-bx-white dark:hover:border-bx-white"
                      : ""
                  }
                ...
                <>
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Button
                      type="button"
                      size="sm"
                      className="shrink-0 border-2 border-bx-black bg-bx-accent font-semibold text-bx-white transition-colors hover:bg-bx-black hover:border-bx-black dark:border-bx-white dark:hover:border-bx-white"
                  ...
                  {autoSchedule ? (
                    <p className="rounded-lg border-2 border-bx-black bg-bx-off px-3 py-2 text-xs text-bx-black dark:border-bx-white dark:bg-bx-gray-dim/30 dark:text-bx-white">
