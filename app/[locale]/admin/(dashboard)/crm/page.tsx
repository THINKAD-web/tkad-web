...
function campaignStatusClass(status: CrmCampaign["status"]) {
  if (status === "active") return "border-2 border-border bg-primary text-primary-foreground";
  if (status === "ended") return "border-2 border-border bg-card text-foreground";
...
function segmentBadgeClass(segment: "high_value" | "potential" | "standard") {
  if (segment === "high_value") return "border-2 border-border bg-primary text-primary-foreground";
  if (segment === "potential") return "border-2 border-border bg-card text-foreground";
  return "border-2 border-border bg-muted/40 text-foreground";
}
...
export default function AdminCrmPage() {
  ...
  return (
    <div className="space-y-6 text-foreground">
      ...
      {tab === "intelligence" && (
        <div className="space-y-4">
          <Card className="border-2 border-dashed border-border bg-muted/40">
            <CardContent className="flex gap-3 py-4">
              <Sparkles className="h-5 w-5 shrink-0 text-primary" />
              <p className="text-sm text-foreground">{t("modelNote")}</p>
            </CardContent>
          </Card>
                  ...
                  {intelligenceRows.map(
                    ({ customer: c, segment, repurchase, rationaleKeys }) => (
                      <tr key={c.id} className="border-b last:border-0">
                        <td className="py-3 pr-3 font-medium text-foreground align-top">
                          {companyLabel(c)}
                        </td>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card>
              ...
              <CardContent className="relative space-y-3">
                ...
                <Button
                  type="button"
                  className="w-full border-2 border-border bg-foreground text-background transition-colors hover:bg-primary hover:border-primary hover:text-primary-foreground"
                  disabled={
            ...
            <Card>
              ...
              <CardContent>
                <Button
                  ...
                  className={
                    autoSchedule
                      ? "border-2 border-border bg-primary text-primary-foreground transition-colors hover:bg-foreground hover:border-border"
                      : ""
                  }
                ...
                <>
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <Button
                      type="button"
                      size="sm"
                      className="shrink-0 border-2 border-border bg-primary font-semibold text-primary-foreground transition-colors hover:bg-foreground hover:border-border"
                  ...
                  {autoSchedule ? (
                    <p className="rounded-lg border-2 border-border bg-muted/60 px-3 py-2 text-xs text-foreground">
