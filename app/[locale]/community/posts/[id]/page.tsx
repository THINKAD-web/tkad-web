  ...
  return (
    <>
      ...
      <article className="bg-bx-white">
        {/* Hero */}
        <header className="border-b-2 border-bx-black px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <h1 className="mt-4 text-2xl font-extrabold tracking-tight text-bx-black sm:text-3xl lg:text-4xl">
              {post.title}
            </h1>
            <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 font-mono text-[11px] uppercase tracking-[0.18em] text-bx-gray-dim">
              <span className="inline-flex items-center gap-1.5">
                <User className="h-3 w-3 text-bx-accent" />
        ...
        <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          <div className="whitespace-pre-wrap break-words text-base leading-relaxed text-bx-black">
            {post.body}
          </div>
        </div>

        {/* Like / Report (client) */}
        <div className="border-t-2 border-bx-black bg-bx-off">
        ...
        {/* 댓글 — 표시 (서버) */}
        <section className="border-t-2 border-bx-black bg-bx-white py-10">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            {post.comments.length === 0 ? (
              <p className="mt-6 border-2 border-bx-black bg-bx-off p-6 font-mono text-[12px] uppercase tracking-[0.22em] text-bx-gray-dim text-center">
                {`// `}
                {isKo
                  ? "첫 댓글을 작성해주세요."
              ...
              <ul className="mt-6 space-y-0">
                {post.comments.map((c) => (
                  <li
                    key={c.id}
                    className="-mt-[2px] border-2 border-bx-black bg-bx-white p-4 sm:p-5"
                  >
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.18em] text-bx-gray-dim">
                        <User className="h-3 w-3 text-bx-accent" />
                    ...
                    <p className="mt-3 whitespace-pre-wrap break-words text-sm leading-relaxed text-bx-black">
                      {c.body}
                    </p>
                  </li>
                ))}
            ...
            {/* 댓글 작성 폼 (client) */}
            <div className="mt-8 border-t-2 border-bx-black pt-8">
        ...
        {/* 정책 안내 */}
        <section className="border-t-2 border-bx-black bg-bx-off py-6">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-bx-gray-dim">
              ...
              <Link
                ...
                className="font-bold text-bx-accent hover:text-bx-black"
              >
                {isKo ? "운영 정책" : "Policy"} →
              </Link>
            </p>
