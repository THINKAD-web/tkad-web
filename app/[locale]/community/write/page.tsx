      ...
      <div className="tkad-landing-neon tkad-planner-neon">
            ...
            <div className="rounded-[30px] border border-white/12 bg-white/6 p-6 shadow-[0_36px_140px_rgba(0,0,0,0.72)] backdrop-blur tkad-neon-border tkad-neon-glow sm:p-8">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-white/14 bg-white/6 px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.22em] text-white transition-colors hover:bg-white/10"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-white/14 bg-black/20 px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.22em] text-white/78 transition-colors hover:bg-white/10 hover:text-white"
                >
        ...
        <NeonSection className="pt-0 pb-20 sm:pb-24">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            <div className="rounded-[30px] border border-white/12 bg-white/6 p-6 shadow-[0_36px_140px_rgba(0,0,0,0.72)] backdrop-blur tkad-neon-border sm:p-8">
              {me ? (
                <CommunityWriteForm
                  locale={locale}
                  currentUser={{
            ...
            <aside className="grid gap-4 self-start">
              <div className="rounded-[28px] border border-white/12 bg-white/6 p-5 backdrop-blur tkad-neon-border">
                ...
                <ol className="mt-4 space-y-3 text-sm leading-relaxed text-white/72">
              ...
              <div className="rounded-[28px] border border-white/12 bg-black/20 p-5 backdrop-blur">
                <p className="font-mono text-[11px] font-bold uppercase tracking-[0.22em] text-white/55">
                  {isKo ? "// note" : "// note"}
                </p>
