      ...
      <section className="border-b-2 border-black bg-hero-void py-12 sm:py-14">
        <div className="ui-container">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <Link
              href="/report"
              className="inline-flex items-center gap-1.5 border-2 border-foreground bg-card px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-foreground transition-colors hover:bg-foreground hover:text-background"
            >
              ← {isKo ? "리포트 아카이브" : "Report archive"}
            </Link>
            <Link
              href="/insights/market"
              className="inline-flex items-center gap-1.5 border-2 border-[#FF6600] bg-[#FF6600]/10 px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#FF6600] transition-colors hover:bg-[#FF6600] hover:dark:text-white text-gray-900"
            >
