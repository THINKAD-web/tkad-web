...
export function CommunityCommentItemCard({
  ...
  return (
    <li className="rounded-[24px] border border-white/12 bg-black/20 p-5 backdrop-blur">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2 font-mono text-[11px] uppercase tracking-[0.18em] text-white/58">
        ...
        {comment.editableByMe ? (
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex rounded-full border border-white/12 bg-white/6 px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-white/78 transition-colors hover:bg-white/10"
            >
      ...
      {editing ? (
        <div className="mt-4 space-y-3">
          <textarea
            ...
            className="w-full resize-none rounded-[20px] border border-white/12 bg-white/6 px-4 py-3 text-sm text-white placeholder:text-white/38 focus:border-white/22 focus:outline-none"
          />
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="font-mono text-[10px] tabular-nums text-white/46">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={!canSubmit}
              className="inline-flex rounded-full border border-[#8B5CF6]/55 bg-[linear-gradient(135deg,rgba(139,92,246,0.26),rgba(59,130,246,0.16))] px-4 py-2 font-mono text-[10px] font-bold uppercase tracking-[0.18em] text-white transition-colors hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        <p className="mt-3 whitespace-pre-wrap break-words text-sm leading-relaxed text-white/84">
          {comment.body}
        </p>
      )}
