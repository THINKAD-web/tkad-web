  ...
  return (
    <li className="rounded-[24px] border dark:border-white/12 border-gray-200 dark:bg-black bg-white/20 p-5 backdrop-blur">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2 tkad-type-label dark:text-white">
        ...
        {comment.editableByMe ? (
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex rounded-full border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 px-3 py-1.5 tkad-type-label dark:text-white text-gray-700 transition-colors hover:dark:bg-white/10 bg-gray-100"
            >
            ...
            <button
              ...
              disabled={busy}
              className="inline-flex rounded-full border border-rose-400/35 bg-[rgba(127,29,29,0.24)] px-3 py-1.5 tkad-type-label text-rose-200 transition-colors hover:bg-[rgba(127,29,29,0.34)] disabled:opacity-60"
            >
              {isKo ? "삭제" : "Delete"}
            </button>
          </div>
      ...
      {editing ? (
        <div className="mt-4 space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="tkad-type-note tabular-nums dark:text-white">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={!canSubmit}
              className="inline-flex rounded-full border border-hermes/40 bg-hermes/15 px-4 py-2 tkad-type-label text-hermes transition-colors hover:bg-hermes/25 disabled:cursor-not-allowed disabled:opacity-50"
            >
