    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-2">
          ...
          {member.company ? (
            <p className="inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.18em] dark:text-white">
      ...
      {member.bio ? (
        ...
        <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.18em] dark:text-white">
          {isKo ? "// 소개 준비 중" : "// bio coming soon"}
        </p>
      )}

      <div className="mt-5 flex flex-wrap items-center gap-4 font-mono text-[11px] uppercase tracking-[0.18em] dark:text-white">
