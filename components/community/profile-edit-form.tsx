...
export function CommunityProfileEditForm({
  ...
  return (
    <form
      ...
      className="mt-6 space-y-4 rounded-[24px] border dark:border-white/12 border-gray-200 dark:bg-black bg-white bg-white/25 p-5 backdrop-blur sm:p-6"
    >
      ...
      {error ? (
        <div className="rounded-[18px] border dark:border-white/14 border-gray-200 dark:bg-black bg-white bg-white/35 px-3 py-2 font-mono text-[12px] dark:text-white text-gray-800">
          {`// `}
          {error}
        </div>
      ) : null}
