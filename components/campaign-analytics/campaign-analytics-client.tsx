  ...
  return (
    <HomeLandingDayNight>
      <AnalyticsShell>
        <Link
          href={backHref}
          className="mb-4 inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.2em] text-white/55 hover:text-white"
        >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 font-mono text-[11px] tracking-tight text-white/55">
        ...
        <p className="mt-4 font-mono text-[10px] tracking-tight text-white/45">
          {`// `}
          {isKo
        ...
        <section className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {kpiCards.map((card) => (
            <div
              key={card.label}
              className={`rounded-[20px] border border-white/12 bg-gradient-to-br ${card.accent} bg-black/40 p-4 backdrop-blur`}
            >
        ...
        <section className="mt-8 rounded-[24px] border border-white/12 bg-black/40 p-4 backdrop-blur sm:p-6">
          <h2 className="font-mono text-[11px] font-black uppercase tracking-[0.24em] text-white/70">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <section className="rounded-[24px] border border-white/12 bg-black/40 p-4 backdrop-blur sm:p-6">
            <h2 className="font-mono text-[11px] font-black uppercase tracking-[0.24em] text-white/70">
              ...
              {data.mediaShares.slice(0, 6).map((m, i) => (
                <li key={m.mediaId}>
                  <Link
                    ...
                    className="flex items-center justify-between gap-2 rounded-[14px] border border-white/10 bg-white/5 px-3 py-2 text-sm transition-colors hover:border-white/20 hover:bg-white/10"
                  >
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
              {data.proofPhotos.map((p, idx) => (
                <button
                  ...
                  className="group relative aspect-[4/3] overflow-hidden rounded-[14px] border border-white/12 bg-black/50 text-left"
                >
                  <Image
                    src={p.imageUrl}
                    alt={p.caption ?? ""}
                  ...
                  />
                  {p.caption ? (
                    <span className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 to-transparent p-2 text-[10px] text-white">
                      {p.caption}
                    </span>
                  ) : null}
                </button>
        ...
        <section className="mt-10 space-y-3 pb-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <BtnBlock
              ...
              className="inline-flex flex-1 min-w-[200px] items-center justify-center gap-2 rounded-[22px] border border-white/14 bg-[linear-gradient(135deg,rgba(168,85,247,0.95),rgba(34,211,238,0.95))] text-white"
            >
            ...
            <Link
              ...
              className="inline-flex flex-1 min-w-[200px] items-center justify-center gap-2 rounded-[22px] border border-white/14 bg-white/8 px-6 py-3 text-center font-bold text-white backdrop-blur transition-colors hover:bg-white/12"
            >
...
function AnalyticsShell({ children }: { children: ReactNode }) {
  return (
    <div className="tkad-landing-neon tkad-planner-neon min-h-[calc(100vh-72px)] bg-[#0A0A0A] px-4 py-8 text-white">
