...
export function GuidesBeginnerCta({
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 px-6 py-12 text-center backdrop-blur border-gray-200 dark:border-white/12 sm:px-10 sm:py-16">
      <div
        aria-hidden
      ...
      <div className="relative">
        ...
        <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap">
          <Link
            href="/media"
            className="tkad-qp-cta inline-flex h-12 items-center justify-center gap-2 rounded-[18px] px-6 text-sm font-black dark:text-white text-gray-900"
          >
            {mediaCta}
