  ...
  return (
    <NeonSection className="pt-10 pb-12 sm:pt-16 sm:pb-20">
      <NeonSectionHead
        ...
        meta={t("budgetMeta")}
      />
      <div className="mx-auto mt-8 max-w-2xl rounded-[28px] border border-white/12 bg-white/6 p-6 backdrop-blur tkad-neon-border sm:p-8">
        <p className="text-center text-sm text-white/75">{t("budgetLead")}</p>
        <p className="mt-4 text-center font-mono text-2xl font-black tabular-nums text-white">
          {formatted}
        ...
        <button
          type="button"
          onClick={goToMedia}
          className="tkad-neon-cta-clean mx-auto mt-6 flex h-14 w-full max-w-md items-center justify-center gap-2 rounded-[22px] px-8 text-sm font-black text-white transition-transform hover:-translate-y-1 sm:text-base"
        >
          {t("budgetCta")}
