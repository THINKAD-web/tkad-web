...
function GoogleLoginButtonInner({ className }: Props) {
  ...
  return (
    ...
    >
      ...
      {loading ? t("googleConnecting") : t("googleLogin")}
    </button>
  );
}

export const GoogleLoginButton = withSearchParamsSuspense(GoogleLoginButtonInner);
