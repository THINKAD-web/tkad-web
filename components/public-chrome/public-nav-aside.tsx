  ...
  return (
    <aside
      className={cn(
        ...
        "dark:border-white/10 dark:bg-[#05050a] dark:text-white",
        className,
      )}
      aria-label={t("nav.sidebarLabel")}
    >
      <div className="flex h-16 shrink-0 items-center border-b border-border/60 px-5 dark:border-white/10">
        <Link
          href="/"
          className="whitespace-nowrap text-[18px] font-black tracking-tight text-foreground dark:text-white"
        >
      ...
      <div className="shrink-0 border-t border-border/60 p-4 dark:border-white/10">
        <Link
          href="/contact"
          className="tkad-neon-cta-clean inline-flex h-11 w-full items-center justify-center rounded-xl px-4 font-mono text-[11px] font-black uppercase tracking-[0.2em] text-white transition-colors"
        >
          {t("nav.contact")}
        </Link>
      </div>
