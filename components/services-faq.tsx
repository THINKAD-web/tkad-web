              ...
              <AnimatedCard delay={staggerDelayMs(i)}>
                <div className="-mt-[2px] overflow-hidden rounded-[2px] border dark:border-white/14 border-gray-200 dark:bg-white/5 bg-gray-50 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
                  ...
                  >
                    <span
                      aria-hidden
                      className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center border dark:border-white/20 border-gray-300 dark:bg-white/10 bg-gray-100 tkad-type-caption font-bold text-cyan-200"
                    >
                      Q
                    </span>
                  ...
                  >
                    <div className="min-h-0 overflow-hidden">
                      <div className="tkad-services-faq-answer flex items-start gap-3 border-t dark:border-white/12 border-gray-200 dark:bg-black bg-white/25 px-5 pb-4 pt-4 sm:px-6 sm:pb-5">
                        <span
                          aria-hidden
                          className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center border dark:border-white/18 border-gray-300 dark:bg-white/8 bg-gray-100 tkad-type-caption font-bold dark:text-white text-gray-800"
                        >
                          A
                        </span>
