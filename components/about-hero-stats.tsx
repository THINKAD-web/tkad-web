...
export function AboutHeroStats({
  ...
  return (
    <div className="mx-auto mt-14 grid max-w-3xl grid-cols-1 gap-8 border-t border-white/15 pt-12 sm:grid-cols-3 sm:gap-10">
      <ScrollAnimate variant="fade-up" delay={0} className="text-center">
        ...
        <div className="mt-2 text-[11px] font-medium uppercase tracking-wide text-white/65 sm:text-xs">
          {labels.founded}
        </div>
      </ScrollAnimate>
