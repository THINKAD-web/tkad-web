...
export function DaumAddressSearch({ isKo, value, onChange, disabled }: Props) {
  ...
  return (
    <div className="space-y-2">
      <span className="block tkad-type-label dark:text-white text-gray-500">
        {isKo ? "주소" : "Address"}
      </span>
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="tkad-neon-cta-clean shrink-0 rounded-xl px-4 py-2.5 tkad-type-label dark:text-white text-gray-900 disabled:opacity-50"
        >
          {loading
            ? isKo
              ? "로딩…"
      ...
      {open ? (
        ...
        >
          <button
            type="button"
            className="absolute right-2 top-2 z-10 rounded-lg border dark:border-white/15 border-gray-200 dark:bg-white/10 bg-gray-100 px-2 py-1 tkad-type-note font-bold dark:text-white text-gray-900"
