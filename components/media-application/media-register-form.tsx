...
const labelCls =
  "block tkad-type-label dark:text-white text-gray-500";
const sectionTitleCls =
  "tkad-type-label dark:text-white text-gray-800";
  ...
  if (successId) {
    return (
      <div className="mx-auto max-w-xl rounded-2xl border dark:border-white/12 border-gray-200 dark:bg-white/6 bg-gray-50 p-10 text-center backdrop-blur">
        ...
        <p className="mt-6 tkad-type-note dark:text-white">ID: {successId}</p>
        <Link
          href="/"
          className="tkad-neon-cta-clean mt-8 inline-flex items-center justify-center rounded-2xl px-8 py-3 tkad-type-label dark:text-white text-gray-900"
        >
          {isKo ? "홈으로" : "Home"}
        </Link>
      </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <button
        ...
        className="tkad-neon-cta-clean inline-flex w-full items-center justify-center gap-2 rounded-2xl py-4 tkad-type-label dark:text-white text-gray-900 transition-transform hover:-translate-y-0.5 disabled:opacity-50 sm:w-auto sm:min-w-[14rem] sm:px-12"
      >
