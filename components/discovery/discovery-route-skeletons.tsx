...
/** `DiscoveryMediaCard` map-tile variant — stacked tile (image top, body below) */
export function DiscoveryMapTileSkeleton({ className }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden
    >
      <DiscoveryBone className="aspect-[4/3] w-full" />
      <div className="space-y-2 p-2.5">
        <DiscoveryBone className="h-3 w-16" />
        <DiscoveryBone className="h-4 w-4/5" />
        <DiscoveryBone className="h-3 w-1/2" />
        <DiscoveryBone className="h-4 w-2/3" />
