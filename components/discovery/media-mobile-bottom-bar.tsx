    ...
    >
      <div className="flex min-w-0 items-center gap-2 px-3 py-2">
        ...
        >
          ...
          {isKo ? "필터" : "Filter"}
          {activeFilterCount > 0 ? (
            <span className="ml-0.5 inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-hermes px-1.5 text-[11px] font-bold leading-none text-white">
              {activeFilterCount}
            </span>
          ) : null}
        </button>
