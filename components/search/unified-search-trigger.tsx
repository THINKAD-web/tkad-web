    ...
    <>
      ...
      >
        <span className="flex min-w-0 flex-1 items-center gap-2 px-3">
          ...
          <span
            className={cn(
              "truncate  tkad-type-body text-muted-foreground dark:text-white",
            )}
          >
            {t("searchPlaceholderUnified")}
          </span>
        </span>
        <kbd className="hidden shrink-0 items-center gap-0.5 self-center border-l border-border/40 px-2.5 tkad-type-label text-muted-foreground dark:border-white/12 border-gray-200 dark:text-white text-gray-400 sm:inline-flex">
          <span>⌘</span>
          <span>K</span>
        </kbd>
      </button>
