      ...
      <div className="border-2 border-border bg-card p-6">
        {submitted ? (
          <div className="flex flex-col items-center py-8 text-center">
            ...
            <p className="mt-3 tkad-type-meta tracking-tight text-muted-foreground">
              {`// `}{isKo
          ...
          <>
            <div className="mb-6">
              <div className="mb-3 inline-flex items-center gap-1.5 border-2 border-border bg-accent px-3 py-1 tkad-type-label text-accent-foreground">
