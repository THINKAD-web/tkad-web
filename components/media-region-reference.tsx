...
export default function MediaRegionReference() {
  ...
  return (
    <details className="group rounded-lg border border-navy/10 bg-slate-50/90 text-left shadow-sm">
      <summary className="flex cursor-pointer list-none items-center gap-2 px-3 py-2.5 text-xs font-semibold text-navy transition-colors hover:bg-slate-100/80 [&::-webkit-details-marker]:hidden">
      ...
      <div className="space-y-3 border-t border-navy/8 px-3 pb-3 pt-2">
        ...
        <div className="max-h-[min(55vh,22rem)] space-y-2.5 overflow-y-auto pr-1 text-[10px] leading-relaxed">
