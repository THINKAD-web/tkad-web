...
const gradientBtn =
  "inline-flex items-center justify-center rounded-xl bg-hermes px-6 py-3 text-sm font-semibold dark:text-white text-gray-900 shadow-[0_8px_28px_rgba(15,95,92,0.35)] transition-opacity hover:opacity-95 disabled:opacity-50";
