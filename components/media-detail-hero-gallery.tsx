...
export default function MediaDetailHeroGallery({
  ...
  if (!hasImage) {
    return (
      <section className="tkad-home-hero tkad-neon-surface relative w-full overflow-hidden bg-[#05050a] text-white">
  ...
  return (
    <section className="tkad-home-hero tkad-neon-surface relative w-full overflow-hidden bg-[#05050a] text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-stretch px-4 py-10 sm:px-6 lg:px-12">
        <div className="group relative aspect-[16/9] w-full overflow-hidden rounded-[28px] border border-white/12 bg-black/20 shadow-[0_28px_120px_rgba(0,0,0,0.75)] backdrop-blur">
          <div
            aria-hidden
