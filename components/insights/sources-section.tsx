...
export function SourcesSection({ sources }: { sources: InsightSource[] }) {
  ...
  return (
    ...
    >
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 flex-1 space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-2 tkad-type-label text-muted-foreground">
                  <span>{s.domain}</span>
      ...
      <p className="mt-4 tkad-type-caption tracking-tight text-muted-foreground">
