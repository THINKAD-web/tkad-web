      ...
      <div className="space-y-2">
        ...
        <p className="leading-relaxed text-foreground">
          ...
          <a
            ...
            className="border-b-2 border-border pb-0.5 tkad-type-meta font-bold tracking-tight text-foreground transition-colors hover:border-accent hover:text-accent"
          >
            {CONTACT_EMAIL}
          </a>{" "}
          로 알려주세요.
