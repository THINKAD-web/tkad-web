  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg text-sm font-semibold whitespace-nowrap transition-all duration-200 outline-none active:scale-95 motion-reduce:active:scale-100 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/35 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        cta:
          "bg-cta text-white shadow-sm hover:bg-cta-hover hover:shadow-md focus-visible:ring-cta/35",
        destructive:
        ...
        outline:
          "border-2 border-border/70 bg-card text-foreground shadow-sm hover:bg-secondary/70 hover:border-border dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
