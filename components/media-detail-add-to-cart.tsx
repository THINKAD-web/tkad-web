    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {ids.length > 0 && (
        ...
        >
          ...
          <span className="inline-flex h-[18px] min-w-[18px] items-center justify-center bg-gradient-to-br from-violet-600 to-cyan-500 px-1 text-[10px] font-bold text-white shadow-[0_1px_8px_rgba(124,58,237,0.35)] dark:from-violet-500 dark:to-cyan-400">
            {ids.length}
          </span>
        </Link>
      )}
