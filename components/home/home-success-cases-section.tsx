  ...
  return (
    <div className="mt-5 sm:mt-8 lg:mt-10">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link
          href="/cases"
          className="inline-flex items-center gap-2 font-display text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground transition-colors hover:text-primary"
        >
          {t("homeCasesViewAll")}
