...
export default function MediaDetailAdminActions({
  ...
  return (
    <Link
      href="/admin/medias"
      className={`inline-flex items-center gap-1.5 border-2 border-hero-fg bg-hero-void/40 px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-hero-fg backdrop-blur transition-colors hover:bg-card hover:text-foreground ${className}`}
    >
