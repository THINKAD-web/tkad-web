        ...
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 flex items-center gap-2 text-2xl font-black tracking-tight dark:text-white text-gray-900 sm:text-3xl">
              <Bell className="h-7 w-7 text-[color:var(--qp-accent)]" aria-hidden />
            ...
            {filtered.map((n) => (
              <li key={n.id}>
                <button
                  ...
                  className={cn(
                    glassCard,
                    "w-full text-left transition-colors hover:border-[color:var(--qp-accent)]/30 hover:dark:bg-white/8 bg-gray-100",
                    !n.isRead && "border-[color:var(--qp-accent)]/25 ring-1 ring-[color:var(--qp-accent)]/20",
                  )}
                >
