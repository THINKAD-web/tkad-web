      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-[1.2fr,1fr] sm:gap-6">
        ...
        >
          ...
          <input
            ...
            className="h-11 min-w-0 flex-1 rounded-md border-2 border-border bg-card px-3 text-sm text-foreground focus:border-accent focus:outline-none disabled:opacity-60"
          />
          <button
            type="submit"
            disabled={status === "loading" || status === "success"}
