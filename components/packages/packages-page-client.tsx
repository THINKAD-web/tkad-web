  ...
  return (
    <div className="min-h-screen bg-[#F4F4F2] text-foreground transition-colors dark:bg-[#0A0A0A]">
      ...
      <section
        ...
        className="border-y border-black/[0.04] dark:bg-white/5 bg-gray-500 backdrop-blur dark:border-white/[0.06] dark:bg-white/[0.025]"
      >
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        {visible.length === 0 ? (
          <div className="flex flex-col items-center gap-4 rounded-3xl border-2 border-dashed border-black/10 dark:bg-white/6 bg-gray-500 p-12 text-center dark:border-white/12 border-gray-200 dark:bg-white/[0.03]">
            <Sparkles className="h-7 w-7 text-violet-500" aria-hidden />
            <p className="text-lg font-bold text-foreground">{t("filter.empty")}</p>
            <Link
              href="/planner"
              className="inline-flex h-11 items-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-cyan-400 px-5 text-sm font-bold dark:text-white text-gray-900"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 sm:pb-24 lg:px-8">
        <div className="relative overflow-hidden rounded-[28px] border dark:border-white/10 border-gray-200 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-500 p-8 dark:text-white text-gray-900 shadow-[0_30px_120px_rgba(139,92,246,0.45)] sm:p-12">
          <div
            aria-hidden
          ...
          <div className="relative grid grid-cols-1 gap-6 sm:grid-cols-[1.4fr,1fr] sm:items-center">
            <div>
              ...
              <p className="mt-3 max-w-xl text-base leading-relaxed dark:text-white text-gray-800 sm:text-lg">
                {t("custom.subtitle")}
              </p>
            </div>
