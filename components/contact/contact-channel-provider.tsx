      ...
      >
        ...
        <div className="space-y-3">
          <a
            ...
            onClick={onClose}
            className="flex w-full flex-col rounded-xl bg-[#FEE500] px-4 py-3.5 text-left text-gray-900 transition hover:brightness-95"
          >
          ...
          <button
            ...
            className="flex w-full flex-col rounded-xl bg-gray-100 px-4 py-3.5 text-left text-gray-900 transition hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/15"
          >
            <span className="font-semibold">
          ...
          <Link
            href="/contact"
            onClick={onClose}
            className="flex w-full flex-col rounded-xl bg-gradient-to-r from-violet-500 to-cyan-400 px-4 py-3.5 text-left text-white transition hover:opacity-95"
          >
            <span className="font-semibold">
