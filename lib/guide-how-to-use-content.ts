...
export const HOW_TO_USE_STEPS: HowToUseStep[] = [
  ...
  },
  {
    step: "05",
    icon: "📋",
    titleKo: "30초 안에 견적 신청",
    titleEn: "Request a quote in 30 seconds",
    bulletsKo: [
      '매체 상세에서 "문의하기" 클릭',
      '또는 플래너 완성 후 "견적 받기"',
      "회사명, 예산, 기간, 목적 입력",
    ...
    bulletsEn: [
      'Click "Inquire" on media detail pages',
      'Or "Get quote" after finishing a planner plan',
      "Enter company, budget, period, and goals",
      "A manager contacts you within ~24 hours",
    ],
    ctaKo: "지금 견적 받기 →",
    ctaEn: "Get a quote →",
    href: "/contact",
...
export const HOW_TO_USE_FAQS: HowToUseFaq[] = [
  {
    ...
    answerKo:
      "네, 매체 탐색·비교·기본 플래너는 무료입니다. 상세 시뮬레이션·PDF 보고서는 PRO 플랜에서 제공됩니다.",
    answerEn:
      "Yes — media browse, compare, and basic planner are free. Advanced simulation and PDF reports require PRO.",
  },
  {
