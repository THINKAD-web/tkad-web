...
export const OOH_CONTRACT_TEMPLATE_KO_VERSION = "1.1.0";
...
export const OOH_CONTRACT_PARTY_B_KO = {
  ...
  address: "서울특별시 성동구 뚝섬로 17가길 48 11층",
  tel: "02-515-2772",
 ...
 * 문구 기준: 2026-09-18 ㈜기어세컨드·홍대 상진빌딩 싱커드 표준 계약서 PDF 대조본.
 */
export const OOH_CONTRACT_TEMPLATE_KO_ARTICLES: readonly OohContractTemplateSection[] =
  [
    ...
    },
    {
      ...
      heading: "전문",
      paragraphs: [
        '{{clientCompany}}(이하"갑"이라한다)과 (주)싱커드(이하"을"이라한다.)는 상호간에 광고 계약을 서로 협의하여 다음과 같이 체결한다.',
      ],
    },
    {
      kind: "article",
    ...
    },
    {
      ...
      heading: "제5조 (광고물의 제작)",
      paragraphs: [
        '제5조 (광고물의 제작) 1) 광고 면은 "갑"이 제시한 사양의 원고에 의해 "을"이 제작, 설치하고, 계약 기간 중 "갑"의 요구에 의한 광고면 변경시 교체 비용은 "갑"이 부담한다. 2) "을"은 "갑"으로부터 광고안 확인 및 심의를 하여야 하며, 심의 완료 후 일정에 맞추어 제작, 설치를 완료하여야 한다. 3) 설치가 완료된 이후 7일 이내 설치보고서를 "갑"에게 제출한다.',
      ],
    },
    {
      kind: "article",
    ...
    },
    {
      ...
      heading: "제7조 (계약의중도해지)",
      paragraphs: [
        '제7조 (계약의중도해지) "갑"은 다음 각 항에 해당되는 경우 발생시, "을"과의 사전 협의를 거쳐 본 계약을 해지할 수 있으며, 이 경우 해당 월의 광고료는 일할 계산하여 정산 지급하는 것을 원칙으로 한다. 1) "을"이 "갑"의 정당한 요구사항을 성실히 이행하지 않았을 경우. 2) "을"의 귀책사유로 인하여 광고대행 및 관리에 현저한 장애가 발생하여 계약의 성실한 이행이 불가능하다고 "갑"이 판단하고 "을"이 인정하였을 때. 3) 해당 관청 및 상급기관의 행정명령에 의해 광고물이 철거되는 경우. 4) 계약기간 중 계약목적물의 법적인, 허가기간 및 입찰 등으로 인한 사용기간의 만기가 도래하거나 기타 계약목적물에 관한 사용 및 임차기간이 종료된 경우. 5) 상기 각 항의 경우 외에 "갑"의 일방적인 사정에 의해 광고계약을 해지할 경우 다음과 같이 위약금을 지불하며 할인 또는 서비스 송출을 포함하는 경우 해당 비용을 모두 포함한 금액으로 계산한다. (1) 광고 시작 전 광고계약이 해지되는 경우 "갑"은 "을"에게 전체 계약기간에 대한 광고료 50%를 현금 일시불 지급한다. 단, 계약 해지 시점에 제작, 시공이 들어간 경우 해당 비용은 100% 일시불 지급한다. (2) 광고 시작 후 광고계약이 중도 해지되는 경우 "갑"은 "을"에게 전체 계약기간에 대한 광고료 100%를 현금 일시불 지급한다.',
      ],
    },
    {
      kind: "article",
      heading: "제8조 (불가항력 등)",
      paragraphs: [
        '제8조 (불가항력 등) 1) 계약기간 중에 천재지변, 폭동, 전쟁, 정부의 규제 등 사회 통념상 불가항력 적 사유로 계약이행이 불가능할 경우, 계약 불이행에 대한 책임을 지지 않는다.',
      ],
    },
    {
      kind: "article",
      heading: "제9조 (자료제공 및 비밀유지)",
      paragraphs: [
        '제9조 (자료제공 및 비밀유지) 1) "갑" 또는 "을"은 옥외광고에 필요한 정보 및 자료제공에 상호협조 하여야 하며, "갑"과 "을"은 이를 통해 알게 된 영업 관련 정보를 상호 서면 동의 없이 임의로 이용하거나 제 3자에게 제공 또는 공개하여서는 아니된다.',
      ],
    },
    {
      kind: "article",
      heading: "제10조 (재판관할)",
      paragraphs: [
        '제10조 (재판관할) 1) 본 계약상의 분쟁에 관한 재판관할은 "갑"의 소재지를 관할하는 법원으로 한다. 2) 본 계약서는 계약의 성실한 이행을 위하여 본 계약서를 2부 작성하여 "갑", "을" 기명날인 후 각각 1부씩 보관한다.',
      ],
    },
    {
      kind: "article",
      heading: "제11조 (효력발생)",
      paragraphs: [
        '제11조 (효력발생) 1) 본 계약은 계약체결일로부터 효력이 발생한다.',
      ],
    },
    {
      kind: "signature",
      ...
      paragraphs: [
        "{{contractDate}}",
        '"갑" 상호 : {{clientCompany}} 주소 : {{clientAddress}} 전화번호 : {{clientPhone}} 대표자 : {{clientRepName}} (인)',
...
export function isOohContractTemplateKoSourceComplete(): boolean {
  ...
  if (articles.length !== 11) return false;
