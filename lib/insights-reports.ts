...
/** PR-5: 공개 상세 페이지에 인용된 출처 (Tavily 등 외부 검색 결과) */
...
export type InsightReport = {
  ...
  /** PR-5: slug 가 있으면 `/insights/[slug]` 상세 페이지 라우팅 가능. null = 리스트만. */
  slug: string | null;
  labelKo: string;
  labelEn: string;
  titleKo: string;
  ...
  /** PR-5: 상세 페이지 본문 마크다운 (DB 직접 매핑 시에만 채워짐) */
  contentKo?: string;
  /** PR-5: Tavily 등 인용 출처 (DB 직접 매핑 시에만 채워짐) */
  sources?: InsightSource[];
  /** PR-5: AI 자동 생성 여부 — 상세 페이지 배너 노출 조건 */
