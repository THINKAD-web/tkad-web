export const KAKAO_AUTH_REDIRECT_COOKIE = "tkad_kakao_auth_redirect";
export const KAKAO_AUTH_LOCALE_COOKIE = "tkad_kakao_auth_locale";
...
export function applyKakaoAuthCookies(
  ...
  res.cookies.set(KAKAO_AUTH_LOCALE_COOKIE, locale || "ko", COOKIE_OPTS);
}
